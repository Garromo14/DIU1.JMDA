...
En esta práctica hemos aprendido a poner en el centro del análisis al usuario y a partir de esto rediseñar el sitio web de la práctica 1. Hemos realizado para ello [Empathy Map](img/Empathy_map.png) y [Feedback Capture Grid](img/Feedback_Capture_Grid.png). Esto nos ha llevado a realizar la propuesta definida en [Scope Canvas](img/Scope_Canvas.png). A continuación definimos las tareas a realizar por el usuario representadas como [User Task Flows](img) y [Task Matrix](resources/TaskMatrix.md). Continuamos definiendo nuestro sitio con 
[Sitemap](img/sitemap.png) y Labelling y por último realizamos el diseño de la web. Este diseño se ha hecho en forma de [Bocetos a mano](resources/Bocetos.pdf) y posteriormente en una representación de mayor nivel en forma de [Wireframes](img).

En cuánto al trabajo del equipo, la comunicación ha sido fluida y no ha habido ningún problema, además de que hemos repartido el trabajo de forma equitativa supervisando lo realizado por la otra persona.
